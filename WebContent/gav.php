...
<html>
	<?php 
	   include 'include/fonctions_gav.php';
	?>
<head>
<meta charset="utf-8">
		...
		<section class="container">
			<div class="row">
				<div class="col-md-12 text-center mt-2">
					<h2 class="text-warning text-center py-5">Gardes &agrave; Vues</h2>
				</div>
				<div class="col-md-12 text-center mt-5 text-light">
					<p>Vous pouvez ici enregister une garde &agrave; vue, et y avoir acc&egrave; en temps r&eacute;el.</p>
				</div>
				<div class="col-md-12 text-center text-light">
					<button type="button" class="btn btn-primary" data-toggle="modal" data-target="#exampleModal">
						Enregistrer une garde &agrave; vue
					</button>
				</div>
					...
					<div class="modal-dialog" role="document">
						<div class="modal-content">
							<div class="modal-header bg-dark">
								<h5 class="modal-title" id="exampleModalLabel">Gardes &agrave; Vues</h5>
							...
							<div class="modal-body bg-secondary">
								<form method="post">
									...
									<label class="text-center text-danger">Dur&eacute;e</label>
										<input class="form-control" id="inserer" type="text" name="duree">
							</div>
					...
					<div class="table table-responsive d-flex justify-content-center">
						<table class="table table-dark">
							<tr class="text-center">
								<th>Num&eacute; de la Garde &agrave; Vue</th>
								<th>Nom</th>
								<th>Pr&eacute;nom</th>
								<th>Matricule</th>
								<th>Raisons</th>
							...
							<?php 
							     $reponse = $db->query('SELECT * from gav');
							     while ($gav = $reponse->fetch()){
							?>
							<tbody>
								<tr>
									<td class="text-center"><?php echo $gav['id']?></td>
									<td class="text-center"><?php echo $gav['nom']?></td>
									<td class="text-center"><?php echo $gav['prenom']?></td>
									<td class="text-center"><?php echo $gav['matricule']?></td>
									<td class="text-center"><?php echo $gav['raison']?></td>
									<td class="text-center"><?php echo $gav['duree']?></td>
									<td><a class="suppr" href="gav.php?supprimer_gav=<?php echo $gav['id'] ?>"> X</a></td>
								</tr>
								<?php 
							     }
								?>
